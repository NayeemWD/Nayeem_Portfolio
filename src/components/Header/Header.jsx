...
const Header = () => {
  ...
  useEffect(() => {
    ...
    // If system changes (like user switches OS theme)
        ...
        <div className="flex gap-6 items-center">
          ...
          <div className="flex gap-4">
            ...
            <div className="relative inline-block text-left">
              <button className="btn gap-2 " onClick={() => setIsOpen(!isOpen)}>
                {renderBadge()}
              </button>
